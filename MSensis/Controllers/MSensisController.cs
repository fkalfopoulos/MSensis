...
namespace MSensis.Controllers
{
    ...
    public class MSensisController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreatePDF(string id)
        {
            ...
            Generator generatorPdf = new Generator(_db, _env);
            var objectSettings = new ObjectSettings
            {

                PagesCount = true,
                Page = $"https://localhost:44389/Home/ViewInvoice/{id}",
                //await generatorPdf.CreatePDF(id), 
                //$"https://localhost:44389/Home/ViewPdf/{id}",
